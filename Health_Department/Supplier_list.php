        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-fluid  flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Supplier list /</span> Supplier List</h4>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body p-5 ">
                      <div class="table-responsive text-nowrap">
                        <table id="dataTable" class="datatables-basic table table-hover  border-top "
                          style="width:100%">
                          <thead class="">
                            <tr>
                              <th>Date Created</th>
