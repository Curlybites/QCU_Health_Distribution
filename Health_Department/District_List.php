		...
		<div class="layout-wrapper layout-content-navbar">
				<div class="layout-container">
						...
						<div class="layout-page">
														...
														<div class="col-md-12">
																<div class="card mb-4">
																		<div class="title d-flex align-items-center justify-content-between border-top border-success">
																				...
																				<button class="btn-success mx-4 px-4 py-1 border-0" data-bs-toggle="modal" data-bs-target="#district-m"> <i class='bx bxs-add-to-queue'></i>Create New</button>
																		</div>

																		<div class="modal fade" id="district-m" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
																								...
																								<div class="modal-body">
																										<form class="row">
																												<div class="mb-3">
																														...
																														<input type="text" name="districtNumber" class="form-control" id="districtNumber">
																												</div>
																												<!-- <div class="mb-3">
								...
								<script src="scripts/Add_district.js">
