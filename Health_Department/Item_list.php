                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                ...
                                <form class="row g-2">
                                  ...
                                  <div class="col-md-12 ">
                                    ...
                                    <div class="col-md-12">
                                        <label for="catergory" class="form-label">Category Name</label>
                                      ...
                                      <div class="col-md-12">
                                            <label for="catergory" class="form-label">Supplier</label>
                                            <select class="form-select" aria-label="Default select example">
                                      ...
                                      <div class="col-md-12">
                                            <label for="catergory" class="form-label">Programs</label>
                                            <select class="form-select" aria-label="Default select example">
