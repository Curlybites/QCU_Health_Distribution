        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2 text-center">Welcome to Health Center! 👋</h4>
              ...
              if (isset($_POST['login'])) {
                ...
                $sql = "SELECT * FROM user WHERE email = '$email' and roles = 4";
            ...
            if (isset($error)) {
              ...
              ?>
              <form id="formAuthentication" class="mb-3" action="HClogin.php" method="POST">
